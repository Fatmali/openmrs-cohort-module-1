...
public class AddCohortAttributesController {
    ...
    public void manage(@RequestParam(required = false, value = "ca") Integer id, WebRequest request, ModelMap model, @ModelAttribute("cohortatt") CohortAttribute cohortattribute) {
        ...
        List<CohortAttributeType> att = s.getAllCohortAttributeTypes();
        ...
        CohortAttributeType cat = s.getCohortAttributeType(a);
        if (cat != null) {
            coat = cat;
        }
    ...
    public String onSubmit(WebRequest request, HttpSession httpSession, ModelMap model,
        ...
        CohortAttributeType att = departmentService.getCohortAttributeType(cohort_attribute_type);
        cohortattribute.setCohort(cohort1);
        cohortattribute.setValue(description);
        cohortattribute.setCohortAttributeType(att);
        departmentService.saveCohortAttribute(cohortattribute);
